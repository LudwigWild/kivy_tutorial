...
class RootWidget(BoxLayout):
	def change_rectangle_color(self, *args):
		...
		self.ids['my_label1'].color = random_color
		self.ids['my_label2'].color = random_color
		self.ids['my_label3'].color = random_color
		self.ids['my_label4'].color = random_color

class KivyApp(App):
	def build(self):
		Builder.load_file('method1.kv')
